...
var SupportTeamDashboardView = KanbanView.extend({
    ...
    render: function() {
        ...
        return this.fetch_data().then(function(result){
            ...
            var support_dashboard = QWeb.render('helpdesk.SupportDashboard', {
                widget: self,
                show_demo: self.show_demo,
                values: result,
            });
            super_render.call(self);
            $(support_dashboard).prependTo(self.$el);
        });
    },
    ...
    on_change_input_target: function(e) {
        ...
        if(isNaN(target_value)) {
            ...
            this._updated = new Model('crm.lead')
                            .call('modify_target_support_dashboard', [target_name, parseInt(target_value)])
                            .then(function() {
                                return self.render();
                            });
        }
...
core.view_registry.add('support_team_dashboard', SupportTeamDashboardView);

return SupportTeamDashboardView;
